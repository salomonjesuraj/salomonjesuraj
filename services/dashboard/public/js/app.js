...
import { ScannerPanel } from './scanner.js?v=radar-r7-1';
...
import { OptimizerPanel } from './optimizer-panel.js?v=noise-reduction-4';
import { AiQueryPanel } from './ai-query-panel.js?v=8.0.0-phase-d';
import { initModeSwitch } from './mode-switch.js?v=8.0.0-new-shell';
import { CockpitV2Panel } from './cockpit-v2.js?v=clean-sweep-lc2';
...
import { EbieVerdictPanel } from './ebie-verdict-panel.js?v=eb15-gaps-1-7b';
