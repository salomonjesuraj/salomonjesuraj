...
_TAXONOMY: list[tuple[str, list[str], float]] = [
    ("regulatory_investigation", [
        "regulatory probe", "sebi probe", "sebi investigation", "raided",
        "cbi raid", "ed raid", "income tax raid", "fraud investigation",
        "show cause notice", "under investigation",
    ], 0.9),
    ("regulatory_approval", [
        "regulatory approval", "gets approval", "receives approval",
        "usfda approval", "drug approval", "clearance from", "nod from sebi",
    ...
    ("stake_sale_purchase", [
        "stake sale", "sells stake", "buys stake", "stake purchase",
        "block deal", "bulk deal", "divests stake", "raises stake",
    ], 0.55),
    ("promoter_pledge", [
        "promoter pledge", "pledged shares", "shares pledged", "pledge of shares",
    ], 0.7),
    ("credit_rating_change", [
        "rating upgraded", "rating downgraded", "credit rating", "rating outlook",
        "crisil rating", "icra rating", "care ratings",
    ], 0.65),
    ("debt_refinancing", [
        "debt refinancing", "refinances debt", "restructures debt", "loan restructuring",
    ], 0.5),
    ("management_change", [
        "resigns", "resignation", "steps down", "appoints new ceo", "new md",
        "new chairman", "management change", "appointed as director",
    ], 0.6),
    ("lawsuit", [
        "lawsuit", "sues", "sued by", "legal notice", "court case", "litigation",
    ], 0.55),
    ("plant_shutdown", [
        "plant shutdown", "shuts plant", "halts production", "temporary shutdown",
        "suspends operations",
    ], 0.65),
    ("production_increase", [
        "capacity expansion", "ramps up production", "new plant", "commissions plant",
        "expands capacity",
    ], 0.5),
    ("order_win", [
        "wins order", "bags order", "secures order", "receives order", "order win",
        "contract win", "wins contract",
    ], 0.55),
    ("earnings_beat", [
        "beats estimates", "beat estimates", "profit jumps", "profit surges",
        "record profit", "results beat",
    ], 0.7),
    ("earnings_miss", [
        "misses estimates", "profit falls", "profit declines", "posts loss",
        "results miss", "widens loss",
    ], 0.7),
    ("guidance_change", [
        "raises guidance", "cuts guidance", "revises guidance", "guidance revised",
        "outlook raised", "outlook cut",
    ], 0.65),
    ("commodity_input_shock", [
        "crude oil", "input cost", "raw material cost", "commodity prices",
        "rising crude", "oil prices",
    ], 0.45),
    ("government_policy", [
        "government policy", "budget announcement", "import duty", "export duty",
        "tariff", "gst rate", "policy change",
    ], 0.5),
    ("sector_policy", [
        "rbi policy", "sebi circular", "sector regulation", "irdai", "trai",
    ], 0.5),
]
